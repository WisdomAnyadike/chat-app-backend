...
const { signUp, login, getUsers, createProfile, addRoleToProfile, getFirstProfile, getAllProfiles, getAllDreams, getProfileWithChosenProfile, setProfileTerms, checkProfileTerms, checkDescription, getFirstProfileTerms, getProfile, uploadProfileDetails, applyToDream, getCurrentUser, setWorkerTerms } = require('../controller/usercontroller')
...
router.get('/setWorker/:profileId', setWorkerTerms)
